    ...
    <>
      ...
      <main className="min-h-screen bg-[#0A0A0A] text-white pt-[54px]">
        <div className="text-center pt-16 pb-8 px-6">
          <h1
            className="text-3xl md:text-4xl font-bold tracking-[-1.5px] leading-[1.12] mb-3"
            style={{ fontFamily: "var(--font-display)" }}
          >
            Book a call
          </h1>
          <p className="text-[15px] text-[rgba(255,255,255,0.4)] font-light max-w-[440px] mx-auto">
