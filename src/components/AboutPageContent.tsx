  ...
  return (
    <section className="pt-28 md:pt-40 pb-16 md:pb-[100px] px-5 md:px-10 max-w-[680px] mx-auto">
      ...
      <div className="space-y-6">
        <Reveal delay={0.16}>
          <p className="text-[15px] md:text-[17px] text-[rgba(255,255,255,0.78)] font-normal leading-[1.8] md:leading-[1.85]">
        ...
        <div className="mt-12 md:mt-16 pt-12 md:pt-16 border-t border-[rgba(255,255,255,0.06)]">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-[14px] text-[rgba(255,255,255,0.65)] font-normal leading-[1.7]">
